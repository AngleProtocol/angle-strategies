...
/// @author Solmate (https://github.com/Rari-Capital/solmate/blob/main/src/tokens/ERC20.sol) with some changes by Angle
/// to add notably the increaseAllowance and decreaseAllowance functions while changing error messages
